...
See @TestSpec, for a User Guide that explains the development
...
The CCSS, ORSci, and NGSS define what students in Oregon should know and be
ableto do by the time they graduate from high school. These CCSS, which were
developed by national stakeholders and education experts, have been determined
to be coherent and rigorous by researchers at the @carmichael2010state. They
were also developed with wide stakeholder involvement, particularly here in
Oregon. The new ORExt is linked directly to the content in the CCSS in English
language Arts (reading, writing, & language) and mathematics. The ORExt is
dually linked to the ORSci as well as the NGSS. The NGSS are widely accepted by
most relevant science instruction organizations as reflective of rigorous and
coherent science concepts.
...
The ORExt assessments were administered in the 2021-22 school year in ELA and
...
District Test Coordinators related to the change (@Exemption).
...
unless the student receives a parent-requested exemption..." (@TestAdministrationManual).

### 1.4A English Learners {.unnumbered}

English learners are included as appropriate in Oregon's statewide assessment
system. (@ELProgramGuide). The Smarter Balanced assessment
...
school year in which the language exceeds the threshold (@OregonSe38:online).
In addition, the accommodations available to students who participate in the
ORExt include translation into the native language, where appropriate (@AccessibilityManual).
